...
Not every private company qualifies to be listed on Primi. This is intentional.

A company must have sufficient secondary market activity to support a credible, continuous reference index. If the data does not meet our standards, the market does not open. If it deteriorates after listing, the market closes.
